...
function main() {
  ...
  function search() {
    ...
    if (selection == 'em1pty') {
      ...
      url = ''
      url = "https://simplebiz.bitrix24.com/rest/10/" + atob(a) + "/batch.json?halt=0"
